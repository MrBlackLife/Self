...
--Disable Anti-flood
  ...
  if redis:get(hash) then
   ...
   return '_Private_ *flood protection* _has been_ *disabled*'
	  ...
	  local te = show_bot_settings(msg)
	  tdcli.editMessageText(msg.to.id, msg.id_, nil, te, 1, 'md')
       end
...
tdcli.sendMessage(msg.sender_user_id_, "", 0, text, 0, "md")
           -- return '_Help was send in your private message_'
			tdcli.editMessageText(msg.to.id, msg.id_, nil, "_Help was send in your private message_", 1, 'md')
end
end
